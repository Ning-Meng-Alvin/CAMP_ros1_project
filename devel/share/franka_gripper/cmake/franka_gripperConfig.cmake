...
if("TRUE" STREQUAL "TRUE")
  set(franka_gripper_SOURCE_PREFIX /home/camp/ros1_project/src/catkin_franka/src/franka_ros/franka_gripper)
  set(franka_gripper_DEVEL_PREFIX /home/camp/ros1_project/devel)
  ...
  set(franka_gripper_INSTALL_PREFIX /home/camp/ros1_project/install)
...
if(NOT "/home/camp/ros1_project/devel/include;/home/camp/ros1_project/src/catkin_franka/src/franka_ros/franka_gripper/include;/usr/local/include " STREQUAL " ")
  set(franka_gripper_INCLUDE_DIRS "")
  set(_include_dirs "/home/camp/ros1_project/devel/include;/home/camp/ros1_project/src/catkin_franka/src/franka_ros/franka_gripper/include;/usr/local/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_gripper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/camp/ros1_project/src/catkin_franka/src/franka_ros/franka_gripper/${idir}'.  ${_report}")
    endif()
    _list_append_unique(franka_gripper_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "franka_gripper;/usr/local/lib/libfranka.so.0.9.0")
